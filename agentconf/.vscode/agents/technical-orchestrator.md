...
description: Use this agent when coordinating complex technical tasks, multi-agent workflows, or large-scale code analysis requiring orchestration of multiple specialized agents in parallel.
